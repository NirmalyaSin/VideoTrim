...
public class DeepVideoTrimmer extends FrameLayout implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    private final GestureDetector.SimpleOnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mVideoView.isPlaying()) {
                ...
                mPlayView.setImageResource(R.drawable.ic_vector_play_gray);
                mMessageHandler.removeMessages(SHOW_PROGRESS);
                mVideoView.pause();
            } else {
                mPlayView.setVisibility(View.VISIBLE);
                mPlayView.setImageResource(R.drawable.pause2);
                if (mResetSeekBar) {
                    mResetSeekBar = false;
    ...
    private void init(Context context) {
        ...
        Button viewButtonSave = findViewById(R.id.btSave);
        ...
        mPlayView.setOnTouchListener(mTouchListener);
